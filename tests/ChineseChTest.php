...
class Numbers_Words_ChineseChTest extends PHPUnit_Framework_TestCase
{
    var $handle;
    var $lang = 'zh_CH';
    ...
    public static function main()
    {
        ...
        PHPUnit_TextUI_TestRunner::run(
            new PHPUnit_Framework_TestSuite('Numbers_Words_ChineseChTest')
        );
    }
    ...
    */
    function testMore()
    {
        ...
        $this->assertEquals('一百万', $this->handle->toWords(1000000, $this->lang));

        $this->assertEquals('二十亿', $this->handle->toWords(2000000000, $this->lang));
